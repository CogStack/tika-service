...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends libtiff-dev build-essential nvidia-driver nvidia-egl-icd mesa-opencl-icd libpocl-dev beignet-opencl-icd nvidia-opencl-icd nvidia-egl-common nvidia-cuda-dev nvidia-cuda-toolkit
